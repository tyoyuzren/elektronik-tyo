<x-app-layout>
    <div class="p-6">
        <div class="mb-6">
            <h1 class="font-bold text-2xl text-text tracking-tight">Tambah Produk</h1>
            <p class="text-text-muted text-sm mt-1">Input data produk baru</p>
        </div>
        ...
        <div class="card max-w-2xl">
            <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="nama_produk" value="{{ old('nama_produk') }}" class="input" required>
                    ...
                    <div class="relative">
                        ...
                        <select name="category_id" class="select pl-10" required>
                            ...
                            @foreach ($kategoris as $k)
                                <option value="{{ $k->id }}" {{ old('category_id') == $k->id ? 'selected' : '' }}>{{ $k->nama_kategori }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="harga" value="{{ old('harga') }}" class="input pl-10" required>
                        </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="stok" value="{{ old('stok') }}" class="input pl-10" required>
                        </div>
